...
const Success = props => (
  <Fragment>
    <Container style={{minHeight:'66vh', display:'flex', justifyContent: 'center', alignItems: 'center'}}>
      ...
      <div className="card-header">
        ...
        <p>We will review your submission shortly, and publish it if the information is complete.</p>
