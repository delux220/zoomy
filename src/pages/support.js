              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="text-center text-white mb-7">
                    <h3 className="pt-5 mt-5 mb-5 font-weight-bold text-dark">
                      {title}
                    </h3>
                  </div>
                  <div
                  ...
                  <div className="text-center">
                    <Link
                      ...
                      target="_blank"
                    >
                      <i className="fa fa-link mr-2" /> Submit a Link
                    </Link>
                    <a
                      href={paypalLink}
                      ...
                      target="_blank"
                    >
                      <i className="fa fa-arrow-right mr-2" /> Make a donation
                    </a>
                  </div>
                </div>
              </div>
        ...
        <Container>
          <div className="section-title center-block text-center">
            ...
            <p className="text-muted">
              Here are a few of Bagel's and my personal favorite local
              establishments. Show them some love!
            </p>
          </div>
          <Row>
            {_map(favorites, post => (
